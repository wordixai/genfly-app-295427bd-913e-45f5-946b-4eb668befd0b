    ...
    <footer className="bg-white border-t-8 border-black zigzag-border py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-3xl comic-text text-black mb-4" style={{ textShadow: '2px 2px 0px #FF6B35' }}>
              POP SHOP
            </h3>
            ...
            <div className="flex gap-3">
              <button className="bg-pink-400 p-2 border-3 border-black hover:bg-pink-300 wiggle">📱</button>
          ...
          <div>
            ...
            <ul className="space-y-2 handwritten text-gray-600">
              ...
              <li><a href="#" className="hover:text-pink-500">Clothing</a></li>
              <li><a href="#" className="hover:text-blue-500">Art Prints</a></li>
              <li><a href="#" className="hover:text-green-500">Accessories</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 handwritten text-gray-600">
              ...
              <li><a href="#" className="hover:text-pink-500">Artists</a></li>
